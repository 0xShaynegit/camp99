...
html_out = build_page(
    slug='media-training-sessions',
    title='Media Training Sessions - Camp 99',
    description='Media Training Sessions - DigitalMission Media. Photography class photos and training sessions in Chiang Mai.',
    hero_img='camp99asia-camp99-asia-page-header-banner.webp',
    hero_h1='Media Training Sessions',
    content_html='\n'.join(content),
)
open('pages/media-training-sessions.html', 'w', encoding='utf-8').write(html_out)
